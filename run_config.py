...
def main( conf, out=None ): 
    ...
    conf = str(pathlib.Path(__file__).parent.absolute()) + os.sep + conf
    ...
    if file.is_file():
        ...
        try:
            ...
            print("Manually aborting configuration")
        #except Exception as e:
        #    print(e)
        #    print("Error for configuration")
...
def eval_algorithm( train, test, key, algorithm, eval, metrics, results, conf, slice=None, iteration=None, out=True ):
    ...
    # Removed this in
    # https://github.com/x775/SW10-Ludewig/commit/e817a21e99b496bec4dce97a575d96a0ec19ee13
    # in order to make factorisation based models work... not sure if effect on GRU4REC.
    #algorithm.clear()
